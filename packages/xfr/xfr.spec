...
- Merge pull request #150 from lance0/fix/93-sparkline-flush-burst
- deps: unify control-channel crypto on one RustCrypto generation
- Merge pull request #151 from lance0/fix/lan-582-crypto-ecosystem
- feat: transfer a fixed number of bytes with -n/--bytes
- fix(-n): cap sendfile at the claimed length, and show byte progress in the TUI
- Merge pull request #152 from lance0/feat/n-bytes-test-by-amount
- fix(tui): drive -u -R progress from a local clock, not server Intervals
- fix(tui): stop the -u -R local metronome once the timed test ends
- Merge pull request #153 from lance0/fix/93-download-local-metronome
- feat(cli): group --help output into sections
- chore: remove dead code and harden auth-path error handling
- fix(output): surface live loss in scripted output when interval reports stall
- docs: changelog entry for grouped --help
- fix(client): suppress UDP/QUIC send-error noise on graceful teardown
- docs: changelog entry for teardown send-error suppression
- Merge pull request #154 from lance0/fix/upload-scripted-stall-rows
- Merge pull request #157 from lance0/fix/teardown-error-noise
- Merge pull request #155 from lance0/feat/grouped-help
- Merge pull request #156 from lance0/chore/dead-code-unwrap-audit
- docs: tick shipped roadmap items (PRs #154-#157)
...
- Bump docker/setup-qemu-action from 3 to 4 (#105)
- Bump docker/build-push-action from 6 to 7 (#106)
- Bump docker/metadata-action from 5 to 6 (#107)
